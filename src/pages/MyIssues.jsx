    ...
    <div className="">
      <div className="border-b border-white/10 flex items-center justify-between ">
        <div className="text-textColor flex gap-3 items-center p-2 pl-6 ">
          ...
          <button className="bg-menuHover rounded p-1 px-2 text-sm  border border-white/10 text-white ">
            Assigned
          </button>
          <button className="text-sm border border-white/10 rounded p-1 px-2 ">
            Created
          </button>
          <button className="text-sm border border-white/10 rounded p-1 px-2 ">
            Subscribed
        ...
        <div>
          <p className="text-textColor pr-8">
            <LuPanelRight />
          </p>
        </div>
      </div>
      ...
      <div className="flex justify-between items-center border-b border-white/10 p-2 ">
        <div className=" text-white flex gap-2 pl-4">
          <IoFilterSharp />
      ...
      <div className="flex flex-col items-center justify-center pt-80">
        <div>
        <svg 
          viewBox="20 23 125 93"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          class="sc-huzrqG hGQphy"
          className="w-50 h-full z-index-0"
        >
          <path
          ...
          <ellipse
            ...
            rx="17"
            ry="11.2"
            transform="matrix(-1 0 0 1 99 63)"
            fill="lch(4.8% 0.7 272)"
            stroke="lch(19% 3.54 272 / 1)"
            stroke-width="1.5"
          ...
          <ellipse
            ...
            rx="17"
            ry="11.2"
            transform="matrix(-1 0 0 1 99 41)"
            fill="lch(4.8% 0.7 272)"
            stroke="lch(90.65% 1.35 272 / 1)"
            stroke-width="1.5"
          ></ellipse>
          <ellipse
            ...
            rx="13"
            ry="7.8"
            transform="matrix(-1 0 0 1 95 44.4)"
            fill="lch(4.8% 0.7 272)"
            stroke="lch(38.29% 1.35 272 / 1)"
            stroke-width="1.5"
        ...
        <div className="flex flex-col gap-2 justify-center items-center pt-5">
            <p className="max-h-full text-textColor">No issues assigned to you</p>
            <button className="bg-Mbutton text-sm text-white rounded w-3/4 p-1">Create new issue</button>
        </div>
      </div>
